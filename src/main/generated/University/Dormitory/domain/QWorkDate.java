...
public class QWorkDate extends EntityPathBase<WorkDate> {
    ...
    public final DateTimePath<java.time.LocalDateTime> breakEndTime = createDateTime("breakEndTime", java.time.LocalDateTime.class);

    public final DateTimePath<java.time.LocalDateTime> breakStartTime = createDateTime("breakStartTime", java.time.LocalDateTime.class);
